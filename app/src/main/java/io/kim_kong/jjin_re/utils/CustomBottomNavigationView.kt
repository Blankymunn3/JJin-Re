...
class CustomBottomNavigationView : BottomNavigationView {
    ...
    private val CURVE_CIRCLE_RADIUS = 175
    ...
    override fun onSizeChanged(w: Int, h: Int, oldw: Int, oldh: Int) {
        ...
        mFirstCurveStartPoint.set(mNavigationBarWidth / 2 - (CURVE_CIRCLE_RADIUS * 1.5).toInt() - CURVE_CIRCLE_RADIUS / 6, 0)
        mFirstCurveEndPoint.set(mNavigationBarWidth / 2, CURVE_CIRCLE_RADIUS + CURVE_CIRCLE_RADIUS / 4)
        mSecondCurveStartPoint = mFirstCurveEndPoint
        mSecondCurveEndPoint.set(mNavigationBarWidth / 2 + (CURVE_CIRCLE_RADIUS * 1.5).toInt() + CURVE_CIRCLE_RADIUS / 6, 0)
